...
for (i in 1:nsims)
{
  ...
  filename=paste('results_sim_Cont',as.character(i),sep='_')
  ...
  # 
  # # stan options
  # clogit_stan3 <- stan("clogitContError.stan", data=datalist3,chains=2,iter=4000)
  ...
  # results=data.frame(Betac,Alpha,Model,realAlpha)
  # 
  # filename=paste(paste('results_tau',tau,sep='='),"sim",as.character(i),sep='_')
  # write_csv(results,file=paste(filename,'.csv',sep=''))
  # 
  # ## rm things
